...
export const collectionSchemas: Record<string, AtlanticDunesCollectionSchema> = {
  ...
  products: {
    ...
    fields: [
      ...
      { name: 'performance', label: 'Performance summary', type: 'textarea', required: true },
      ...
      { name: 'pdfLink', label: 'PDF link', type: 'text', required: true, description: 'URL to a PDF brochure or datasheet.' },
      ...
      { name: 'galleryImageIds', label: 'Gallery images', type: 'multiSelect', relation: { collection: 'images', labelField: 'filename', valueField: '_id', multi: true }, description: 'Choose one or more gallery images.' },
    ],
  },
  boutique: {
    collection: 'boutique',
    ...
    fields: [
      ...
      { name: 'galleryImageIds', label: 'Gallery images', type: 'multiSelect', relation: { collection: 'images', labelField: 'filename', valueField: '_id', multi: true }, description: 'Optional additional images.' },
    ],
  },
  news: {
    collection: 'news',
